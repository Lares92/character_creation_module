...
def attack(char_name: str, char_class: str) -> str:
    """Генерирует количество очков атаки в зависимости
    от выбранного типа персонажа и возвращает строковое
...
def defence(char_name: str, char_class: str) -> str:
    """Генерирует количество очков защиты в зависимости
    от выбранного типа персонажа и возвращает строковое
...
def special(char_name: str, char_class: str) -> str:
    """В зависимости от выбранного типа персонажа возвращает
    сообщение о применении специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Запускает цикл тренировки навыков персонажа. В качестве
    параметров она получает введённое игроком имя персонажа и
    выбранный тип персонажа."""
    if char_class == 'warrior':
...
if __name__ == '__main__':
    """Главная функция. Она запускает игру, и из неё
    вызываются все вспомогательные функции."""
    run_screensaver()
